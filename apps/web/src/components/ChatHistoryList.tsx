...
export function ChatHistoryList({
  ...
  const modalTitle = manageMode
    ? (language === "zh-CN" ? "管理历史" : "Manage History")
    : t("chat.history");
  ...
  return (
    <>
          ...
          <div className="space-y-3">
            <div className="relative">
              ...
              <TextInput
                ...
                placeholder={language === "zh-CN" ? "搜索历史对话..." : "Search chat history..."}
                value={searchQuery}
            ...
            <div className="custom-scrollbar max-h-[420px] space-y-2 overflow-y-auto">
              {groups.length === 0 ? (
                <div className="py-8 text-center">
                  <EmptyState>
                    {searchQuery.trim()
                      ? (language === "zh-CN" ? "没有匹配的对话" : "No matching chats")
                      : t("chat.noChats")}
                  </EmptyState>
                </div>
              ) : (
                            ...
                            return (
                              ...
                              >
                                {manageMode ? (
                                  ...
                                  <MessageSquarePlus size={13} className="shrink-0 text-slate-600" />
                                )}
                                {renamingId === chat.id ? (
                                  <input
                                    ref={renameInputRef}
      ...
      {pendingDeleteChat ? createPortal(
        <ConfirmDialog
      ...
      {batchDeleteConfirm ? createPortal(
        <ConfirmDialog
          cancelLabel={t("common.cancel")}
          confirmLabel={t("common.delete")}
          loading={loading}
