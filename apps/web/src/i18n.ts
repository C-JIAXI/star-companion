...
const zhCN = {
  ...
  "chat.memoryHelp": "1 表示携带上次用户输入与 AI 输出，2 表示前两次。",
  ...
  "help.characterSuffix": "放在角色提示词之后的补充说明，适合写输出格式、禁忌、结尾规则或临场约束。",
...
const en: Record<TranslationKey, string> = {
  ...
  "chat.memoryHelp": "1 includes the previous user input and AI output; 2 includes the previous two.",
  ...
  "help.apiKey": "The secret key used to call the model service. It is encrypted by the backend before local storage, and the frontend never calls providers directly.",
  ...
  "help.characterPrefix": "High-priority text placed before the character prompt, useful for identity boundaries, voice rules, and fixed constraints.",
  "help.characterPrompt": "The main character prompt, useful for persona, background, goals, behavior, and dialogue style.",
  "help.characterSuffix": "Supplemental text placed after the character prompt, useful for output format, restrictions, ending rules, or scene-specific constraints.",
