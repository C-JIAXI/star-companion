...
const zhCN = {
  ...
  "chat.send": "发送",
  "chat.stage4Placeholder": "第 4 阶段已接入 OpenAI-compatible 流式生成。配置 API 后即可生成回复。",
  "chat.stop": "停止",
  "chat.streaming": "正在生成",
  "chat.title": "标题",
...
const en: Record<TranslationKey, string> = {
  ...
  "chat.send": "Send",
  "chat.stage4Placeholder": "Stage 4 streams OpenAI-compatible replies. Configure an API before generating.",
  "chat.stop": "Stop",
