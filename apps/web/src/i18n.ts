...
const zhCN = {
  ...
  "chat.draftNotes": "草稿备注",
  "chat.draftPlaceholder": "第 4 阶段接入 LLM 回复。第 3 阶段会通过 CRUD 保存用户消息。",
  ...
  "settings.backendReachable": "后端代理可访问。模型连接测试将在第 4 阶段接入。",
...
const en: Record<TranslationKey, string> = {
  ...
  "section.chat.subtitle": "Create chats, bind characters, and save user messages through the local API.",
  ...
  "section.settings.subtitle": "Store provider configuration locally. Requests stay behind the backend proxy.",
  "section.settings.title": "Model Settings",
  "stage.label": "MVP Stage 3",
  ...
  "chat.draftNotes": "Draft Notes",
  "chat.draftPlaceholder": "LLM replies arrive in stage 4. Stage 3 saves user messages through CRUD.",
  ...
  "settings.backendReachable": "Backend proxy is reachable. Model connection test arrives in stage 4.",
