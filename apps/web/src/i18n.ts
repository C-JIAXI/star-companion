...
const zhCN = {
  ...
  "chat.send": "发送",
  "chat.regenerate": "重生成",
  "chat.stage4Placeholder": "第 7 阶段已接入群聊顺序回复；group 聊天会按角色绑定顺序依次发言。",
  "chat.stop": "停止",
  "chat.streaming": "正在生成",
...
const en: Record<TranslationKey, string> = {
  ...
  "chat.stage4Placeholder": "Stage 7 adds sequential group replies in bound character order.",
  "chat.stop": "Stop",
