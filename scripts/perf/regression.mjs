...
for (const profileName of profiles) {
  ...
  try {
    ...
    db.close();
    results.push({ profileName, seed: 20260831, counts: metadata.counts, schemaVersion: metadata.schemaVersion, queryPlans: { messages: "indexed", chats: "indexed" }, success: true });
  } finally {
